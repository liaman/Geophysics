...
/********** dat document ***********/
	   ...
	   char FN4[250]={"BP_shot_cal.dat"};
	   char FN5[250]={"BP_VTI_snap.dat"};
	   char FN6[250]={"BP_VTI_migration.dat"};
	   char FN7[250]={"BP_VTI_illumination.dat"};
	   char FN8[250]={"BP_VTI_adcigs.dat"}; 
...
/********aaa************/  
	 FILE *fpsnap, *fpshot, *fpmig, *fpillum, *fpadcigs;
        if((fpshot=fopen(FN4,"rb"))==NULL){printf("error open <%s>!\n",FN4);exit(0);}
        fpsnap=fopen(FN5,"wb");
        fpmig=fopen(FN6,"wb");
