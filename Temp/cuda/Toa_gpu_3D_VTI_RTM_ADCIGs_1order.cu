...
/*************wavelet\boundary**************/
          wtype=1;npml=20;
/********** dat document ***********/
          char FN1[250]={"vel301301201.dat"};
          char FN2[250]={"epsilu.dat"};
          char FN3[250]={"deta.dat"};
	   char FN4[250]={"shot.dat"};
	   char FN5[250]={"snap.dat"};
	   char FN6[250]={"migration.dat"};
	   char FN7[250]={"illumination.dat"};
	   char FN8[250]={"adcigs.dat"};
