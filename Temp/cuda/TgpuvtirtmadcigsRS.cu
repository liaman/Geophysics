...
/********** dat document ***********/
	   ...
	   char FN4[250]={"layer_shot_obs.dat"};     
	   char FN5[250]={"layer_shot_cal.dat"};
	   char FN6[250]={"layer_snap.dat"};
	   char FN7[250]={"layer_migration.dat"};
	   char FN8[250]={"layer_illumination.dat"};
	   char FN9[250]={"layer_adcigs.dat"}; 

/********* parameters *************/
          read=true;/* true: read shot; 
...
/********aaa************/  
	 FILE *fpsnap, *fpobs, *fpcal, *fpmig, *fpillum, *fpadcigs;
...
/***********close************/ 
     ...
     fclose(fpillum);  fclose(fpadcigs);
/***********free*************/ 
