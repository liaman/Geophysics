...
/********** dat document ***********/
          ...
          char FN1[250]={"waxian_vel_801_301.dat"};      
          char FN2[250]={"waxian_epsilon_801_301.dat"};
          char FN3[250]={"waxian_delta_801_301.dat"}; 
	   char FN4[250]={"waxian_shot_cal.dat"};
	   char FN5[250]={"waxian_snap.dat"};
	   char FN6[250]={"waxian_migration.dat"};
	   char FN7[250]={"waxian_illumination.dat"};
	   char FN8[250]={"waxian_adcigs.dat"}; 
	   char FN9[250]={"waxian_adcigs_laplace.dat"}; 
	  char FN10[250]={"waxian_adcigs_dadcigs.dat"}; 
	  char FN11[250]={"waxian_migration_stkAdcigs.dat"}; 
