...
/********** dat document ***********/
    ...
    /*      char FN1[250]={"waxian_3layer/waxian_vel_1001_301.dat"};      
	  ...
	  char FN11[250]={"waxian_3layer/waxian_migration_stkAdcigs.dat"}; */
          ...
          char FN1[250]={"hess/hess_vel_3617_1500.dat"};      
          char FN2[250]={"hess/hess_epsilon_3617_1500.dat"};
          char FN3[250]={"hess/hess_delta_3617_1500.dat"}; 
	   char FN4[250]={"hess/hess_shot_obs.dat"};
	   char FN5[250]={"hess/hess_snap.dat"};
	   char FN6[250]={"hess/hess_migration.dat"};
	   char FN7[250]={"hess/hess_illumination.dat"};
	   char FN8[250]={"hess/hess_adcigs.dat"}; 
	   char FN9[250]={"hess/hess_adcigs_laplace.dat"}; 
	  char FN10[250]={"hess/hess_adcigs_dadcigs.dat"}; 
	  char FN11[250]={"hess/hess_migration_stkAdcigs.dat"}; 

/********* parameters *************/

          nx=3617;              
	   nz=1500;         favg=22;     pfac=1000.0;
