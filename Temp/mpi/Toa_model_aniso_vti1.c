...

{
	...
	void ptsource(float pfac,float xsn,float zsn,int nx,int nz,float dt,float t,
        ...
        void update_vel(int nx,int nz,int npd,int mm,float dt,float dx,float dz,
                        float **up0,float **wp0,float **uq0,float **wq0,float **txx0,
                        float **tzz0,float **up1,float **wp1,float **uq1,float **wq1,
                        float **txx1,float **tzz1,float **rho,float c[],float *coffx1,
                        float *coffx2,float *coffz1,float *coffz2);
        void update_stress(int nx,int nz,float dt,float dx,float dz,int mm,
                        float **up0,float **wp0,float **uq0,float **wq0,float **txx0,
                        float **tzz0,float **up1,float **wp1,float **uq1,float **wq1,
                        float **txx1,float **tzz1,float **s,float **vp,float c[],int npd,
                        float **tpx1,float **tpx0,float **tpz1,float **tpz0,float **tqx1,
                        float **tqx0,float **tqz1,float **tqz0,float *acoffx1,
                        float *acoffx2,float *acoffz1,float *acoffz2,float deta,float epsilu);
	...
	void initial_coffe(float dt,float d0,int nx,int nz,float *coffx1,float *coffx2,
                        float *coffz1,float *coffz2,float *acoffx1,float *acoffx2,
                        float *acoffz1,float *acoffz2,int npd);	
...
void zero3d(int nx,int nz,int nt,int npd,float **u0,float **w0,float **txx0,float **u1,
            float **w1,float **txx1,float **vp,float **rho)
{
		 int i,j,k;
