...
GtkWidget *_nx, *_nz, *_dx, *_dz, *_npd, *_mm, *_nt, *_dt;
GtkWidget *_favg, *_fs, *_ds, *_ns, *_zs;
GtkWidget *_shot, *_snap;
gint nx, nz, npd, mm, fs, ds, ns, zs, dx, dz, favg, nt, dt;
gint run_count=0;
...
//###################################connect to model#########################################
void model_funciton(GtkWidget *widget,gpointer data)
{
     run_count++;
     ...
     model(nx,nz,dx,dz,npd,mm,str_vel,str_epsilu,str_deta,favg,ns,fs,ds,zs,str_shot,str_snap,nt,dt,run_count);
}
//###################################VTI model#########################################
...
////////////////////////////////////a////////////////////////////////////////////
     ...
     gtk_frame_set_label (GTK_FRAME (frame), "Time parameter:");
     gtk_frame_set_label_align (GTK_FRAME (frame), 0.0, 1.0);
...
////////////////////////////////////a////////////////////////////////////////////
     ...
     g_signal_connect(G_OBJECT(button),"clicked",G_CALLBACK(model_funciton),NULL);
